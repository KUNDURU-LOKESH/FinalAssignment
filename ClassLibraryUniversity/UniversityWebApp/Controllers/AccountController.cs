...
using UniversityWebApp.MailSend;
...
namespace UniversityWebApp.Controllers
{
    ...
    {
        Uri baseuri = new Uri("https://localhost:7214/api/Account");
        ...
        public IActionResult Register(RegisterModel registerModel)
        {
            ...
            var baseurl = new Uri("https://localhost:7214/api/UserAPi");
            using (var client = new HttpClient())
            {
                ...
                if (result.IsSuccessStatusCode)
                {
                    ...
                    //mail.SendMailMethod(registerModel.Email, "https://localhost:7266/");
        ...
        public IActionResult AdminPage()
        {
            ...
            Uri baseuri = new Uri("https://localhost:7214/api/UserAPi");
            HttpClient client = new HttpClient();
